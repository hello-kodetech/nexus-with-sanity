...
import {IntegratedLogisticsData} from "@/sanity/types/sanity";
...
const integratedLogistics = async () => {
    ...
    return (
        <div className="min-h-screen bg-[#F6F6F6] poppins">
            ...
            <div
                className="relative lg:-mt-28 md:-mt-28 max-w-7xl mx-auto px-4 sm:px-6 md:px-0 lg:px-8 service-inner-main-div">
                ...
                {pageData.sections && pageData.sections.length > 0 ? (
                    pageData.sections.map((section, sectionIndex) => (
                        <div key={sectionIndex} className="max-w-7xl px-4 sm:px-6 lg:px-8">
