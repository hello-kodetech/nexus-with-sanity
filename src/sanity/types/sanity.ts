...
export interface PhotoDescriptionSectionItem {
    title: string;
    subtitle1?: string;
    subtitle2?: string;
    paragraph1: string;
...
export interface AirAndFreightData {
    ...
    sections?: PhotoDescriptionSectionItem[];
    bottom_banner?: BottomBanner;
    seo?: SeoData;
}


export interface FreightQuoteWidgetData {
...
export interface PostDetails {
    postTitle: string;
    Post_short_description: string;
    postContent_1: TypedObject;
    postContent_2: TypedObject;
    postContent_3: TypedObject;
    postContent_4: TypedObject;
    postImage_1: string;
    postImage_2: string;
    postImage_3: string;
    slug: string;
